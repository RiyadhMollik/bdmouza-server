...
INSTALLED_APPS = [
    ...
    'users',
    'des',
    'epspayment',  # EPS Payment Gateway
...
# Add this for credential path (optional)
import os
...
TIME_ZONE = 'Asia/Dhaka'  # Bangladesh Time (BDT = UTC+6)
...
STATIC_URL = 'static/'
STATIC_URL = '/static/'
STATIC_ROOT = '/home/bdmouzac/api.bdmouza.com/static'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'mouzafile@gmail.com'
EMAIL_HOST_PASSWORD = 'angczqdvsgmrwmus'  # ✅ App Password (no spaces)
DEFAULT_FROM_EMAIL = 'mouzafile@gmail.com'  # ✅ should match EMAIL_HOST_USER
